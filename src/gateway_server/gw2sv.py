...
ACTUATOR_DATA_TOPIC = "farm/monitor/actuator"   # not used in K66 version
ACTUATOR_CONTROL_TOPIC = "farm/control"

SCAN_DEVICE_TOPIC = "farm/node/scan"        
ADD_NODE_TOPIC = "farm/node/add"            
NEW_NODE_TOPIC = "farm/node/new"            # this topic is for sending new node info to server after scanning or adding node?
